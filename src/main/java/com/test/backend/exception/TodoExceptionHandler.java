...
import com.test.backend.controller.ExpenseController;
...
@RestControllerAdvice(assignableTypes = {TodoController.class, TripController.class, PlacesController.class, ExpenseController.class})
